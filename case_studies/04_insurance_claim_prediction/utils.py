...
def train_and_evaluate_model(model, X_train, X_test, y_train, y_test):
    ...
    Handles imbalanced data and zero-division warnings.
    ...
    Returns:
        dict : evaluation metrics (accuracy, precision, recall, f1, roc_auc) as percentages
    """

    # If model is LogisticRegression, add class_weight='balanced' and scaling
